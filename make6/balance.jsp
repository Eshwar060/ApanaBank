<html>
	...
	<body>
		<div id="main" >
			<center><h1>Please Enter Details to Get U'r Account Details </h1></center>
			<div style="display:inline-flex; width:100%;">
				...
				<div style="width:50%;">
					<form method="post" action="SignUp" name="form1" onSubmit="return Fcheck(this)">
						<table cellpadding="4px" align="center">
							<tr>
							<td><b>Account No. : </b></td><td><input name="accontNo" required></td>
							</tr>
							<tr>
